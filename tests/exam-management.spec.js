...
test.describe("Exam Management (CRUD)", () => {
  ...
  test("should add a new exam", async ({ page }) => {
    ...
    const row = page.locator("tbody tr", {
      hasText: "Combined Science Physics",
    });
  ...
  test("should delete an exam", async ({ page }) => {
    ...
    // Verify exam exists
    await expect(
      page.locator("tbody tr", { hasText: "English Language" })
    ).toBeVisible();
  ...
  test("should cancel adding an exam", async ({ page }) => {
    ...
    await expect(
      page.locator("tbody tr", { hasText: "History" })
    ).not.toBeVisible();
  });
  ...
  test("should cancel editing an exam", async ({ page }) => {
    ...
    await expect(
      page.locator("tbody tr", { hasText: "Geography" })
    ).toBeVisible();
    await expect(
      page.locator("tbody tr", { hasText: "Changed Subject" })
    ).not.toBeVisible();
  });
  ...
  test("should cancel deleting an exam", async ({ page }) => {
    ...
    await expect(
      page.locator("tbody tr", { hasText: "Art & Design" })
    ).toBeVisible();
  });
  ...
  test("should calculate finish time correctly", async ({ page }) => {
    ...
    for (const tc of testCases) {
      ...
      const row = page.locator("tbody tr", {
        hasText: `Test ${tc.expectedFinish}`,
      });
